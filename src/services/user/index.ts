...
import { FilterUserRequestBody, FilterUserResponseBody, filterUserApi, DefaultFilterUserQueryKey, ShowUserRequestBody, ShowUserResponseBody, showUserApi, DefaultShowUserQueryKey, CreateUserRequestBody, CreateUserResponseBody, createUserApi, UpdateUserRequestBody, UpdateUserResponseBody, updateUserApi, DeleteUserRequestBody, DeleteUserResponseBody, deleteUserApi } from "./request";
    ...
    export const fetchShowUser = async (
      queryClient: QueryClient,
      params: ShowUserRequestBody
    ) => {
      return queryClient.fetchQuery({
