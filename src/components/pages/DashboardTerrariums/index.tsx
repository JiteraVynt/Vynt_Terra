...
const actionsTable1 = useMemo<TableColumnDefinition<FilterTerrariumResponseBody['terrariums'][number]>[]>(() => [{ name: 'Delete', renderColumn: (innerProps) => (<DashboardButton label={'Delete'} onClick={handleOnClickTable1Delete} {...innerProps.row.original} />) },{ name: 'Edit', renderColumn: (innerProps) => (<DashboardButton label={'Edit'} onClick={handleOnClickTable1Edit} {...innerProps.row.original} />) }], [])
...
<Col xs={24} md={24} xl={18} className={styles.col_2} ><div className={styles.dashboard_content} ><div className={styles.dashboard_content_title} ><Text textType='Text' className={styles.text_9} >{'Terrariums'}</Text></div>
<div className={styles.dashboard_content_filter_table} ><div className={styles.box_8} ><Table data={filterTerrariumQuery.data?.terraria} isHeaderVisible isFooterVisible={false} className={styles.table_1} columns={[]} actions={actionsTable1} wrapperStyle={{ width: "100%", backgroundColor: "rgb(255, 255, 255)", color: "rgb(0, 0, 0)", overflowX: "auto"}} tableStyle={{ backgroundColor: "rgb(255, 255, 255)", color: "rgb(0, 0, 0)", width: "100%", border: "1px solid rgb(0, 0, 0)"}} headerColumnStyle={{ backgroundColor: "rgb(0, 21, 41)", color: "rgb(255, 255, 255)", fontSize: "16px", textAlign: "center", fontWeight: "bold", border: "1px solid rgb(0, 0, 0)", padding: "8px 16px 8px 16px"}} bodyColumnStyle={{ backgroundColor: "rgb(255, 255, 255)", color: "rgb(0, 0, 0)", fontSize: "14px", whiteSpace: "nowrap", textAlign: "left", border: "1px solid rgb(0, 0, 0)", padding: "4px 8px 4px 8px"}} footerColumnStyle={{ backgroundColor: "rgb(255, 255, 255)", color: "rgb(0, 0, 0)", fontSize: "16px", textAlign: "center", fontWeight: "bold", border: "1px solid rgb(0, 0, 0)", padding: "8px 16px 8px 16px"}} /></div></div></div></Col></Row></div></div>
