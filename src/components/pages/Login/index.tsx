...
function Login(props: LoginProps): JSX.Element {
  ...
  return (
    <div className={styles.page_container}>
        ...
        <div className={styles.wrapper_7}>
          ...
          <div className={styles.card_7}>
            <form className={styles.form_1}>
              <div className={styles.input_4_container}>
                <div className={styles.input_4_inner}>
                  <Text textType="Text" className={styles.input_4_label}>
                    {'Email'}
                  </Text>
                  <Text textType="Text" className={styles.input_4_required}>
                    {'*'}
                  </Text>
                </div>
                <ControlledInput
                ...
                />
                <div className={styles.input_4_error_message_container}>
                  <Text textType="Text" className={styles.input_4_required}>
                    {undefined}
                  </Text>
                </div>
      ...
      <DefaultFooter className={styles.defaultheader_1} btn_prop={{}} onPress={{}} />
    </div>
  );
}
