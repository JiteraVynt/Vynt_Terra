    ...
    <div className={styles.page_container}>
      ...
      <div className={styles.box_0}>
        ...
        <Table
          ...
          totalPage={filterTerrariumQuery.data?.total_pages || 1}
      ...
      <DefaultFooter className={styles.defaultheader_1} btn_prop={'Hola'} onPress={{}} />
    </div>
  );
}
