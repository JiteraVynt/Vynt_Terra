...
<Col xs={24} md={24} xl={18} className={styles.col_2} ><div className={styles.dashboard_content} ><div className={styles.dashboard_content_title} ><Text textType='Text' className={styles.text_9} >{'Terrariums Detail'}</Text></div>
<div className={styles.dashboard_content_filter_table} /></div></Col></Row></div></div>
