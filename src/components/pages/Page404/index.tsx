...
<div className={styles.box_0} ><div className={styles.box_0} ><Row gutter={[30,30]} justify='center' align='top' className={styles.row_2} ><Text textType='Text' className={styles.text_13} >{'404'}</Text></Row>
